...
import com.example.ongoingbooking.OngoingOrders.MyListAdapter;
import com.example.ongoingbooking.OngoingOrders.MyListData;

public class UpcomingCustomer extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_upcoming_customer);
